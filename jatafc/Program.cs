...
namespace jatafc
{
    class jatafc_entrypoint
    {
        public static StringBuilder DebugOutput = new StringBuilder();

        static void Main(string[] args)
        {
            Console.WriteLine("JATAFC -- JAudio Toolkit AFC creator");
#if DEBUG
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            Console.WriteLine("!JATAFC build in debug mode, do not push into release!");
            Console.WriteLine("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            ...
            {
                "celeste_loop.wav",
                @"E:\DOLPHIN\root\mansion_us\files\AudioRes\Stream\TMOpen.afc",
            ...
            enc.SampleRate = (ushort)wav.sampleRate;
            enc.format = encFmt;
        ...
        public static void showHelp()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("jatafc.exe <input file> <output file> [-encode-format (pcm16,adpcm4) = adpcm4] [-loop startSample,endSample] [-bananapeel.gain = 1.0]");
